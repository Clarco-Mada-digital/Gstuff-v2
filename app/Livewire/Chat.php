...
class Chat extends Component
{
    ...
    public function render()
    {
        ...
        if($this->user)
        {
            ...
            ->groupBy('users.id', 'users.pseudo', 'users.prenom', 'users.nom_salon', 'users.email', 'users.profile_type', 'users.avatar', 'users.date_naissance', 'users.genre', 'users.intitule', 'users.nom_proprietaire', 'users.created_at', 'users.updated_at')
            ->get();
