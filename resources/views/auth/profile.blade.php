        ...
        <form action="{{route('profile.update')}}" method="POST">
          ...
          <div class="grid grid-cols-1 md:grid-cols-2 gap-5" :class="userType == 'invite' ? 'hidden':''" x-show="currentStep === 1">
            ...
            <div class="mb-4 col-span-2">
              ...
              <textarea rows="4" name="description" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
    ...
    <div class="min-w-3/4 px-5 py-5">
      ...
      <div x-show="userType=='escorte'">
        ...
        <section x-show="pageSection=='compte'">
          ...
          <div class="flex items-center gap-10 flex-wrap">
            <p class="text-justify">{{Auth::user()->description ?? '-'}} </p>
          </div>
