    ...
    <div x-data="{ couvertureForm: false }">
        ...
        src="{{ asset('images/icon_logo.png') }}" @endif
                ...
                <button x-on:click="profileForm = !profileForm"
                    class="flex items-center gap-3 md:-mt-[10%] xl:-mt-[25%] cursor-pointer">
                ...
                <div x-show="profileForm" x-data="imageViewer('')"
                    class="w-full border border-gray-300 shadow rounded-lg p-4">
                    <form action="{{ route('profile.update-photo') }}" method="post" enctype="multipart/form-data"
                        ...
                        <template x-if="imageUrl">
                            <img :src="imageUrl" class="object-cover rounded-md border border-gray-200 mx-auto"
                ...
                <div class="flex items-center justify-center gap-2 text-green-gs">
                    <a href="#" class="flex items-center gap-1"> <svg class="w-5 h-5"
                ...
                @if ($user->profile_type == 'salon')
                    <div class="flex items-center justify-center gap-2 text-green-gs">
                        <a href="#" class="flex items-center gap-1"> <svg class="w-5 h-5"
                                ...
                                viewBox="0 0 48 48"><!-- Icon from All by undefined - undefined -->
                ...
                <div class="w-full flex flex-col gap-0 items-center mb-5">
                    ...
                    <button x-on:click="pageSection='discussion'"
                        ...
                        class="flex items-center w-full p-2 text-green-gs border-b border-gray-400 text-left font-bold cursor-pointer hover:bg-green-gs hover:text-white">Discussion
                        @if ($messageNoSeen > 0)
                            <span
                                class="inline-flex items-center justify-center w-4 h-4 ms-2 text-xs font-semibold text-red-800 bg-red-200 rounded-full">{{ $messageNoSeen }}</span>
                        @endif
                    </button>
                </div>
                    ...
                    <form action="{{ route('profile.update') }}" method="POST">
                        ...
                        <div class="flex justify-between gap-2 mt-6 text-sm md:text-base">
                            <button type="button" @click="prevStep"
                                class="px-4 py-2 bg-gray-300 text-gray-700 rounded-md" x-show="currentStep > 0">
                                Précédent
                            </button>
            ...
            <div class="flex flex-col gap-5 min-w-3/4 px-5 py-5">
                ...
                <div x-show="userType=='invite'">
                    ...
                    <section x-show="pageSection=='compte'">
                        ...
                        <div class="grid grid-cols-2 md:grid-cols-4 items-center gap-10">
                            <span class="flex items-center gap-2"><svg class="w-5 h-5 text-amber-400"
                                    xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
                                    <path fill="currentColor"
                                        d="M5.85 17.1q1.275-.975 2.85-1.537T12 15t3.3.563t2.85 1.537q.875-1.025 1.363-2.325T20 12q0-3.325-2.337-5.663T12 4T6.337 6.338T4 12q0 1.475.488 2.775T5.85 17.1M12 13q-1.475 0-2.488-1.012T8.5 9.5t1.013-2.488T12 6t2.488 1.013T15.5 9.5t-1.012 2.488T12 13m0 9q-2.075 0-3.9-.788t-3.175-2.137T2.788 15.9T2 12t.788-3.9t2.137-3.175T8.1 2.788T12 2t3.9.788t3.175 2.137T21.213 8.1T22 12t-.788 3.9t-2.137 3.175t-3.175 2.138T12 22" />
                        ...
                        <div class="grid grid-cols-1 xl:grid-cols-2 gap-3 w-full">
                            <div class="xl:w-1/2 flex flex-col items-center justify-center gap-4 min-w-full">
                                ...
                                @if ($escortFavorites != '[]')
                                    <div
                                        class="w-full grid grid-cols-1 md:grid-cols-1 2xl:grid-cols-2 items-center mb-4 gap-2">
                            ...
                            <div class="relative xl:w-1/2 flex flex-col items-center justify-center gap-5 min-w-full">
                                ...
                                @if ($escortFavorites != '[]')
                                    <div id="NewEscortContainer"
                                        class="w-full flex items-center justify-start overflow-x-auto flex-nowrap mt-5 mb-4 px-5 gap-4"
                                    ...
                                    <div id="arrowEscortScrollRight"
                                        class="absolute 2xl:hidden top-[40%] left-1 w-10 h-10 rounded-full shadow bg-amber-300/60 flex items-center justify-center cursor-pointer"
                                        data-carousel-prev>
                                    ...
                                    <div id="arrowEscortScrollLeft"
                                        class="absolute 2xl:hidden top-[40%] right-1 w-10 h-10 rounded-full shadow bg-amber-300/60 flex items-center justify-center cursor-pointer"
                                        data-carousel-next>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32"
                                            viewBox="0 0 24 24">
                                            <path fill="currentColor"
                ...
                <div x-show="userType=='escorte'">
                    ...
                    @if ($user->profile_verifie === 'verifier')
                        <div
                            class="w-full p-5 rounded-xl flex items-center justify-between border border-blue-gs text-blue-gs">
                    ...
                    @if ($invitationsRecus->isNotEmpty())
                        ...
                        <div
                            class="relative w-full overflow-y-auto bg-white border border-gray-100 rounded-lg dark:bg-gray-700 dark:border-gray-600 m-h-50">
                            <ul>
                                @foreach ($invitationsRecus as $invitationsRecu)
                                    <li class="border-b border-gray-100 dark:border-gray-600">
                                        <a href="#"
                                            class="flex items-center w-full px-4 py-3 hover:bg-gray-50 dark:hover:bg-gray-800 justify-between">
                                        ...
                                        src="{{ asset('images/icon_logo.png') }}" @endif
                                            ...
                                            <button
                                                class="py-2 px-3 w-32 flex items-center justify-center rounded-lg bg-green-gs text-sm xl:text-base text-white cursor-pointer hover:bg-green-800"
                        ...
                        <div x-data="{ id: '', avatar: '', nomSalon: '', date: '', type: '', email: '' }"
                            ...
                            <!-- Modale -->
                            <div
                                class="bg-white rounded-lg shadow-lg p-6 w-[35vw]  max-h-[90vh] xl:max-w-7xl overflow-y-auto">
                                ...
                                <div class="flex items-center mt-4 justify-between">
                                    ...
                                    <div class="w-[50%]">
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Nom du salon : <span
                                                ...
                                                x-text="nomSalon"></span></p>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Email : <span
                                                class="font-medium text-gray-900 dark:text-white" x-text="email"></span>
                                        </p>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Date d'envoi : <span
                                                class="font-medium text-gray-900 dark:text-white" x-text="date"></span>
                                        </p>
                                        <p class="text-sm text-gray-500 dark:text-gray-400">Type : <span
                                                class="font-medium text-gray-900 dark:text-white" x-text="type"></span>
                                        </p>
                                    </div>
                                </div>
                                <div class="flex justify-end items-center gap-4">
                                    <!-- Bouton pour refuser l'invitation -->
                                    <form :action="`{{ route('annuler.invitation', ':id') }}`.replace(':id', id)"
                                    ...
                                    <form :action="`{{ route('accepter.invitation', ':id') }}`.replace(':id', id)"
                                        method="POST" class="inline">
                                        @csrf
                        ...
                        <div class="bg-white rounded-lg shadow-lg p-6 w-[50vw] max-h-[90vh] xl:max-w-7xl overflow-y-auto">
                            ...
                            <div x-data="imageViewer('')" class="w-full border border-gray-300 shadow rounded-lg p-4">
                                <form action="{{ route('profile.updateVerification') }}" method="post"
                                    enctype="multipart/form-data" class="w-full flex flex-col justify-center gap-5">
                                    @csrf()
                                    <h3 class="font-dm-serif text-sm text-green-gs text-center">Image de vérification</h3>
                                    <template x-if="imageUrl">
                                        <img :src="imageUrl"
                                            class="object-cover rounded-md border border-gray-200 mx-auto"
                                            style="width: 100px; height: 100px;">
                                    </template>
                                    ...
                                    <button type="submit"
                                        class="btn-gs-gradient font-bold py-2 px-4 rounded">Envoyer</button>
                                </form>
                    ...
                    <section x-show="pageSection=='compte'">
                        ...
                        <div class="flex flex-col justify-center gap-5 flex-wrap">
                            ...
                            <div class="flex items-center gap-5">
                                <span
                                    class="px-2 border border-green-gs text-green-gs rounded-lg hover:bg-amber-300">{{ $user->categorie['nom'] ?? '' }}</span>
                            </div>
                            ...
                            <div class="flex items-center gap-5">
                                @foreach ($user->service as $service)
                                    <span
                                        class="px-2 border border-green-gs text-green-gs rounded-lg hover:bg-amber-300">{{ $service['nom'] ?? '' }}</span>
                                @endforeach
                            </div>
                    ...
                    <section x-show="pageSection=='compte'">
                        ...
                        <div class="mt-10 xl:mt-0 w-full flex items-center flex-col gap-2">
                            <div class="w-full flex flex-col xl:flex-row items-center gap-2">
                                ...
                                <span
                                    class="w-[40%] text-sm xl:text-base text-center text-green-gs font-bold font-dm-serif">Aucun
                                ...
                                <span
                                    class="w-[40%] text-sm xl:text-base text-center text-green-gs font-bold font-dm-serif">Aucun
                                    escort associé pour l'instant</span>
                            </div>
