        ...
        <div  class="w-full xl:w-1/2 mx-auto px-2 pb-5 pt-30 xl:pt-0 xl:px-30 flex flex-col items-center justify-center gap-20">
          ...
          <form class="flex w-full mx-auto  flex-col gap-5" action="{{ route('register') }}" method="POST">
            ...
            <div class="relative z-0 w-full mb-5 group">
              <input type="text" name="pseudo" id="floating_user_name" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-amber-300 appearance-none dark:text-white dark:border-amber-600 dark:focus:border-green-gs focus:outline-none focus:ring-0 focus:border-green-gs @error('user_name') border-red-500 dark:border-red-500 dark:focus:border-red-500 focus:border-red-500 @enderror peer" placeholder=" " value="{{ old('pseudo') }}" autocomplete="pseudo" required />
