    ...
    <div x-data="{ 'InviteForm': true }" class="relative w-full overflow-x-hidden">
        ...
        <div x-data="{ 'registerForm': '' }" x-show="InviteForm" x-transition:enter="transition ease-in-out duration-500"
            ...
            <div
                ...
                <h2 class="font-roboto-slab text-center text-2xl font-bold text-green-gs">{{ __('register_form.become_member') }}</h2>
                ...
                <form class="mx-auto flex w-full flex-col gap-5" action="{{ route('register') }}" method="POST">
                    ...
                    <x-form.floating-input
                        name="date_naissance"
                        :label="__('register_form.birth_date')"
                        type="date"
                        :required="true"
                    ...
                    <x-form.floating-input
                        name="password"
                        :label="__('register_form.password')"
                        type="password" 
                        :required="true"
                    ...
                    <x-form.floating-input
                        ...
                        :label="__('register_form.confirm_password')"
                        type="password"
                        :required="true"
                        autocomplete="new-password" 
                    />
                    ...
                    <x-form.terms-checkbox
                        name="cgu_accepted"
                        :label="__('register_form.accept_terms')"
                        :termsText="__('register_form.terms_conditions')"
                        :termsLinkText="__('register_form.terms_conditions_link')"
