...
@section('content')
    <div class="py-50 relative w-full" style="background: url('images/girl_deco_image.jpg') center center /cover">
        <div class="absolute left-0 top-0 z-0 flex h-full w-full items-center justify-center bg-black/30">
            <h2 class="font-dm-serif z-10 text-center text-5xl font-bold text-amber-400">{{ __('contact.contact_us') }}</h2>
        </div>
    </div>
                ...
                @if (auth()->user())
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <button id="showConseil" class="cursor-pointer">
                            <h2 class="font-dm-serif text-green-gs text-center text-xl">{{ __('contact.need_info') }}</h2>
                        </button>
                    </div>
                    <div id="comment" class="m-auto flex h-full w-[36%] flex-col items-center p-2">
                        ...
                        <button id="showCommentaire" class="cursor-pointer">
                            <h2 class="font-dm-serif text-green-gs text-center text-xl">{{ __('contact.make_comment') }}
                            </h2>
                        </button>
                    </div>
                @else
                    ...
                    <g id="SVGRepo_iconCarrier">
                        ...
                        <button id="showConseil" class="cursor-pointer">
                            <h2 class="font-dm-serif text-green-gs text-center text-2xl">{{ __('contact.need_info') }}</h2>
                        </button>
                    </div>
                @endif
            </div>
