...
<div class="w-full flex items-center justify-center bg-green-gs/30 py-20">
    <h2 class="font-dm-serif text-5xl text-center text-green-gs">{{__('glossary.glossary_title')}}</h2>
</div>
<div class="md:w-[80%] w-full h-auto mx-auto p-2 flex items-center flex-wrap xl:flex-nowrap justify-center gap-3 bg-white rounded-md xl:-translate-y-[50%] -translate-y-[30%] shadow-lg">
    ...
    <a href="#" class="w-10 h-10 flex items-center justify-center rounded-md bg-white text-green-gs border border-gray-300 font-dm-serif text-base xl:text-xl font-bold hover:bg-green-gs hover:text-white transition-all">{{ Str::upper($item) }}</a>
    @endforeach
</div>
