...
<div x-data="articleForm()" x-init="init()" class="max-w-4xl mx-auto px-4 py-8" x-cloak>
    <h1 class="text-3xl font-bold text-gray-800 mb-6">{{ __('article_edit.edit_article') }} ({{$article->title}})</h1>
    ...
    <form action="{{ route('articles.update', $article->id) }}" method="POST" class="bg-white rounded-lg shadow-md p-6">
        ...
        <!-- Titre -->
        <div class="mb-6">
            <label for="title" class="block text-sm font-medium text-gray-700 mb-1">{{ __('article_edit.title') }}*</label>
        ...
        <!-- Slug -->
        <div class="mb-6">
            <label for="slug" class="block text-sm font-medium text-gray-700 mb-1">{{ __('article_edit.slug') }}*</label>
        ...
        <!-- excerpt -->
        <div class="mb-6">
            <label for="excerpt" class="block text-sm font-medium text-gray-700 mb-1">{{ __('article_edit.excerpt') }}*</label>
        ...
        <div x-data="app()" x-init="init($refs.wysiwyg)" class="mb-6">
          <label for="content" class="block text-sm font-medium text-gray-700 mb-1">{{ __('article_edit.content') }}*</label>
        ...
        <!-- Catégorie -->
        <div class="mb-6">
            <label for="article_category_id" class="block text-sm font-medium text-gray-700 mb-1">{{ __('article_edit.category') }}*</label>
        ...
        <!-- Tags -->
        <div class="mb-6">
            <label class="block text-sm font-medium text-gray-700 mb-2">{{ __('article_edit.tags') }}</label>
        ...
        <div class="mb-6">
            <div class="flex items-center">
                ...
                <label for="is_published" class="ml-2 block text-sm text-gray-700">{{ __('article_edit.publish_article') }}</label>
            </div>
        </div>
    ...
    <div x-show="showTagModal"
        ...
        <div x-on:click.away="closeCreateTagModal"
            ...
            <h3 class="text-lg font-medium text-gray-900 mb-4">{{ __('article_edit.create_tag') }}</h3>

            <div class="mb-4">
                <label for="newTagName" class="block text-sm font-medium text-gray-700 mb-1">{{ __('article_edit.new_tag_name') }}*</label>
