...
@section('admin-content')
    <div class="min-h-screen w-full bg-gray-100 p-5">
        <div class="w-full p-5">
            ...
            <div class="mb-6 mt-6">
                <div class="relative w-96">
                    <input type="text" id="global-search" class="w-full max-w-md rounded border p-2 pr-10"
                        placeholder="{{ __('others.searchTable') }}">
                    <button id="clear-global-search"
        ...
        <div class="space-y-8" id="tables-container">
            <!-- Tableau Genres -->
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="genres"
                data-section-translate="{{ __('others.genres') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.genres') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="genres" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="genres">
                                ✕
                            </button>
                        </div>
                        <button
                            class="bg-green-gs hover:text-green-gs border-green-gs hover:border-green-gs add-btn cursor-pointer rounded border px-3 py-1 text-white hover:bg-white"
                            data-type="genres">
                            {{ __('others.add') }}
                        </button>
                    </div>
                </div>
                <table class="font-roboto-slab w-full border-collapse">
                    <thead>
                        <tr class="rounded-t-sm bg-gray-200">
                            <th class="border p-2">
            ...
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="orientationSexuelle"
                data-section-translate="{{ __('others.orientationSexuelle') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.orientationSexuelle') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="orientationSexuelle" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="orientationSexuelle">
                                ✕
                            </button>
                        </div>
                        <button
                            class="bg-green-gs hover:text-green-gs border-green-gs hover:border-green-gs add-btn cursor-pointer rounded border px-3 py-1 text-white hover:bg-white"
                            data-type="orientationSexuelle">
                            {{ __('others.add') }}
                        </button>
                    </div>
                </div>
            ...
            <!-- Tableau Silhouette -->
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="silhouette"
                data-section-translate="{{ __('others.silhouette') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.silhouette') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="silhouette" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="silhouette">
                                ✕
                            </button>
                        </div>
                        <button
            ...
            <!-- Tableau Catégories -->
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="catégories"
                data-section-translate="{{ __('others.categories') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.categories') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="categories" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
            ...
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="nombre de filles"
                data-section-translate="{{ __('others.nombreFilles') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.nombreFilles') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="nombreFilles" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="nombreFilles">
                                ✕
                            </button>
                        </div>
                        <button
                            class="bg-green-gs hover:text-green-gs border-green-gs hover:border-green-gs add-btn cursor-pointer rounded border px-3 py-1 text-white hover:bg-white"
                            data-type="nombreFilles">
                            {{ __('others.add') }}
                        </button>
                    </div>
                </div>
            ...
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="pratiques sexuelles"
                data-section-translate="{{ __('others.pratiquesSexuelles') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.pratiquesSexuelles') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="pratiquesSexuelles" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="pratiquesSexuelles">
                                ✕
                            </button>
                        </div>
                        <button
                            class="bg-green-gs hover:text-green-gs border-green-gs hover:border-green-gs add-btn cursor-pointer rounded border px-3 py-1 text-white hover:bg-white"
                            data-type="pratiquesSexuelles">
                            {{ __('others.add') }}
                        </button>
                    </div>
                </div>
            ...
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="couleurs des yeux"
                data-section-translate="{{ __('others.couleursYeux') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.couleursYeux') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="couleursYeux" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="couleursYeux">
                                ✕
                            </button>
                        </div>
                        <button
                            class="bg-green-gs hover:text-green-gs border-green-gs hover:border-green-gs add-btn cursor-pointer rounded border px-3 py-1 text-white hover:bg-white"
                            data-type="couleursYeux">
                            {{ __('others.add') }}
                        </button>
                    </div>
                </div>
            ...
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="couleurs des cheveux"
                data-section-translate="{{ __('others.couleursCheveux') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.couleursCheveux') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="couleursCheveux" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="couleursCheveux">
                                ✕
                            </button>
                        </div>
                        <button
                            class="bg-green-gs hover:text-green-gs border-green-gs hover:border-green-gs add-btn cursor-pointer rounded border px-3 py-1 text-white hover:bg-white"
                            data-type="couleursCheveux">
                            {{ __('others.add') }}
                        </button>
                    </div>
                </div>
            ...
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="mensurations"
                data-section-translate="{{ __('others.mensurations') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.mensurations') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="mensurations" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="mensurations">
                                ✕
                            </button>
                        </div>
                        <button
                            class="bg-green-gs hover:text-green-gs border-green-gs hover:border-green-gs add-btn cursor-pointer rounded border px-3 py-1 text-white hover:bg-white"
                            data-type="mensurations">
                            {{ __('others.add') }}
                        </button>
                    </div>
                </div>
            ...
            <!-- Tableau Poitrines -->
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="poitrines"
                data-section-translate="{{ __('others.poitrines') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.poitrines') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="poitrines" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="poitrines">
                                ✕
                            </button>
                        </div>
                        <button
            ...
            <!-- Tableau Pubis -->
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="pubis"
                data-section-translate="{{ __('others.pubis') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.pubis') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="pubis" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="pubis">
                                ✕
            ...
            <!-- Tableau Tatouages -->
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="tatouages"
                data-section-translate="{{ __('others.tatouages') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.tatouages') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="tatouages" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="tatouages">
                                ✕
                            </button>
                        </div>
                        <button
            ...
            <!-- Tableau Mobilités -->
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="mobilités"
                data-section-translate="{{ __('others.mobilites') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.mobilites') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="mobilites" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="mobilites">
                                ✕
                            </button>
                        </div>
                        <button
            ...
            <!-- Tableau Services -->
            <div class="table-section rounded-lg bg-white p-4 shadow" data-section="services"
                data-section-translate="{{ __('others.services') }}">
                <div class="mb-4 flex items-center justify-between">
                    <h2 class="font-roboto-slab text-green-gs text-xl">{{ __('others.services') }}</h2>
                    <div class="flex space-x-2">
                        <div class="relative">
                            <input type="text"
                                class="search-input font-roboto-slab ring-green-gs rounded border p-2 pr-10"
                                data-table="services" placeholder="{{ __('others.search') }}">
                            <button
                                class="clear-search absolute right-3 top-1/2 -translate-y-1/2 transform text-gray-500 hover:text-gray-700"
                                data-table="services">
                                ✕
    ...
    <div id="modal" class="fixed inset-0 flex hidden items-center justify-center bg-black/50 bg-opacity-50">
        <div class="w-1/3 rounded-lg bg-white p-6">
            <h3 id="modal-title" class="mb-4 text-lg font-bold">{{ __('others.addElement') }}</h3>
            <form id="modal-form">
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <input type="text" id="modal-nom-fr"
                            class="font-roboto-slab ring-green-gs w-full rounded border p-2">
                    </div>
                    <div id="modal-categories" class="flex hidden flex-wrap gap-4">
                        <!-- Bouton radio pour "Escort" -->
                        <div class="flex items-center gap-2">
                            <input type="radio" id="modal-escort-radio" name="modal-category"
                                class="text-green-gs focus:ring-green-gs h-5 w-5 rounded focus:ring-2">
                            <label for="modal-escort-radio" class="cursor-pointer font-medium text-gray-700">
                                {{ __('others.escort') }}
                            </label>
                        </div>
                        <!-- Bouton radio pour "Salon" -->
                        <div class="flex items-center gap-2">
                            <input type="radio" id="modal-salon-radio" name="modal-category"
                                class="h-5 w-5 rounded text-blue-600 focus:ring-2 focus:ring-blue-500">
                            <label for="modal-salon-radio" class="cursor-pointer font-medium text-gray-700">
                                {{ __('others.salon') }}
                            </label>
                        </div>
                    </div>

                    <div id="modal-categories-select" class="flex hidden flex-wrap gap-4">
                        <!-- Bouton radio pour "Escort" -->
                        <div class="flex items-center gap-2">
                            <input type="radio" id="modal-services-radio-escort" name="modal-category"
                                class="text-green-gs focus:ring-green-gs h-5 w-5 rounded focus:ring-2" value="escort">
                            <label for="modal-services-radio-escort" class="cursor-pointer font-medium text-gray-700">
                                {{ __('others.escort') }}
                            </label>
                        </div>
                        <!-- Bouton radio pour "Salon" -->
                        <div class="flex items-center gap-2">
                            <input type="radio" id="modal-services-radio-masseuse" name="modal-category"
                                class="text-green-gs focus:ring-green-gs h-5 w-5 rounded focus:ring-2" value="masseuse">
                            <label for="modal-services-radio-masseuse" class="cursor-pointer font-medium text-gray-700">
                                {{ __('others.masseuse') }}
                            </label>
                        </div>
                        <div class="flex items-center gap-2">
                            <input type="radio" id="modal-services-radio-dominatrice" name="modal-category"
                                class="text-green-gs focus:ring-green-gs h-5 w-5 rounded focus:ring-2"
                                value="dominatrice">
                            <label for="modal-services-radio-dominatrice"
                                class="cursor-pointer font-medium text-gray-700">
                                {{ __('others.dominatrice') }}
                            </label>
                        </div>
                        <div class="flex items-center gap-2">
                            <input type="radio" id="modal-services-radio-transvestite" name="modal-category"
                                class="text-green-gs focus:ring-green-gs h-5 w-5 rounded focus:ring-2"
                                value="transvestite">
                            <label for="modal-services-radio-transvestite"
                                class="cursor-pointer font-medium text-gray-700">
                ...
                <div class="mt-4 flex justify-end space-x-2">
                    <button type="button" id="modal-cancel"
                        class="rounded bg-gray-300 px-3 py-1">{{ __('others.cancel') }}</button>
                    <button type="submit"
                        class="bg-green-gs hover:text-green-gs border-green-gs hover:border-green-gs font-roboto-slab cursor-pointer rounded border px-3 py-1 text-white hover:bg-white">{{ __('others.save') }}</button>
                </div>
            </form>
        </div>
    </div>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function renderTable(type, data, fields) {
                ...
                data.forEach(item => {
                    ...
                    editBtn.className =
                        'px-2 py-1 bg-yellow-500 text-white rounded edit-btn tooltip-container';
            ...
            function openEditModal(type, id) {
                ...
                document.getElementById('modal-nom-fr').value = type === 'categories' ? item?.nom?.[locale] ?? '' :
                    item?.name?.[locale] ?? '';
                if (type === 'categories') {
                    document.getElementById('modal-categories').classList.remove('hidden');
            ...
            function setupEventListeners() {
                ...
                document.getElementById('modal-form').addEventListener('submit', async function(e) {
                    ...
                    if (type === 'services') {
                        ...
                        const radioEscort = document.getElementById('modal-services-radio-escort');
                        const radioMasseuse = document.getElementById('modal-services-radio-masseuse');
                        const radioDominatrice = document.getElementById(
                            'modal-services-radio-dominatrice');
                        const radioTransvestite = document.getElementById(
                            'modal-services-radio-transvestite');
                    ...
                    try {
                        ...
                        toastr.success(id ? '{{ __('others.successUpdated') }}' :
                            '{{ __('others.successAdded') }}');
                        closeModal();
                        ...
                        submitBtn.textContent = id ? '{{ __('others.edit') }}' :
                            '{{ __('others.add') }}';
                    }
                });
