            ...
            <main class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
                ...
                <div class="mb-6 flex items-start space-y-2 sm:flex-row sm:space-x-4 sm:space-y-0">
                    ...
                    <div class="relative w-full sm:w-48">
                        <select x-model="filters.status"
                            class="block w-full rounded-md border-gray-300 py-2 pl-3 pr-10 text-base shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500">
                    ...
                    <div class="relative w-full">
                        ...
                        <input x-model="filters.search" type="text"
                            class="block w-full rounded-md border border-gray-300 py-2 pl-10 pr-3 shadow-sm focus:border-blue-500 focus:outline-none focus:ring-blue-500"
                ...
                <div class="mb-8 grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-4">
                    <div class="rounded-lg bg-white p-6 shadow">
                        ...
                        <div class="mt-4">
                            <a href="{{ route('articles.index') }}"
                                class="text-sm font-medium text-blue-600 hover:text-blue-800">{{ __('admin_dashboard.view_all') }}
                                →</a>
                        </div>
                    </div>
                    <div class="rounded-lg bg-white p-6 shadow">
                    ...
                    <div class="rounded-lg bg-white p-6 shadow">
                        <div class="flex items-center justify-between">
                            <div>
                                <p class="flex items-center text-lg font-medium text-gray-500">
                    ...
                    <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
                        <div class="flex items-center gap-3">
                            <h2 @click="sort.field = 'title'; sort.direction = sort.direction === 'asc' ? 'desc' : 'asc'; sortedArticles()"
                                class="text-lg font-semibold text-gray-900">{{ __('admin_dashboard.recent_articles') }}
                            </h2>
                            <span x-show="sort.field === 'title'" x-text="sort.direction === 'asc' ? '↑' : '↓'"
                                class="ml-1"></span>
                        </div>
                        <a href="{{ route('articles.create') }}" class="text-sm text-blue-600 hover:text-blue-800">+
                ...
                <!-- Activité récente -->
                <div class="border-b bg-gray-50 px-6 py-2">
                    <select x-model="activityFilter" class="rounded border-gray-300 text-sm">
                ...
                <div class="grid grid-cols-1 gap-8 lg:grid-cols-2">
                    <div class="overflow-hidden rounded-lg bg-white shadow">
                        <div class="flex items-center justify-between border-b border-gray-200 px-6 py-4">
                            <h2 class="text-lg font-semibold text-gray-900">{{ __('admin_dashboard.recent_activity') }}
                            </h2>
                            <a href="{{ route('activity.index') }}"
                                class="text-sm text-blue-600 hover:text-blue-800">{{ __('admin_dashboard.view_all') }}</a>
                        </div>
                        <div class="divide-y divide-gray-200">
                            ...
                            <template x-for="activity in recentActivity" :key="activity.id">
                                <div class="px-6 py-4">
                                    <div class="flex items-start">
                                        <img class="mr-3 h-10 w-10 rounded-full" :src="activity.causer.avatar"
