        ...
        <form action="{{ route('users.store') }}" method="POST">
            ...
            <div class="mb-6 rounded-lg bg-white p-6 shadow">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-4">
                    <div>
                        <label for="pseudo"
                            class="mb-1 block text-sm font-medium text-gray-700">{{ __('create_user.full_name') }} *</label>
                    ...
                    <div>
                        <label for="profile_type"
                            class="mb-1 block text-sm font-medium text-gray-700">{{ __('create_user.profile_type') }}
                            *</label>
                    ...
                    <div>
                        <label for="email"
                            class="mb-1 block text-sm font-medium text-gray-700">{{ __('create_user.email') }} *</label>
                    ...
                    <div>
                        <label for="email"
                            class="mb-1 block text-sm font-medium text-gray-700">{{ __('create_user.birth_date') }}
                            *</label>
                    ...
                    <div class="col-span-2">
                        <label for="password"
                            class="mb-1 block text-sm font-medium text-gray-700">{{ __('create_user.password') }} *</label>
                    ...
                    <div class="col-span-2">
                        <label for="password_confirmation"
                            class="mb-1 block text-sm font-medium text-gray-700">{{ __('create_user.confirm_password') }}
                            *</label>
            ...
            <div class="mb-6 rounded-lg bg-white p-6 shadow">
                <h2 class="mb-4 text-lg font-medium text-gray-900">{{ __('create_user.roles') }}</h2>
                <div class="space-y-3">
