        ...
        <form action="{{ route('users.update', $user) }}" method="POST">
            ...
            <div class="mb-6 rounded-lg bg-white p-6 shadow">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <div>
                        <label for="pseudo" class="mb-1 block text-sm font-medium text-gray-700">Pseudo *</label>
                    ...
                    <div>
                        <label for="password" class="mb-1 block text-sm font-medium text-gray-700">Nouveau mot de
                            passe</label>
            ...
            <div class="mb-6 rounded-lg bg-white p-6 shadow">
                <h2 class="mb-4 text-lg font-medium text-gray-900">Rôles</h2>
                <div class="space-y-3">
