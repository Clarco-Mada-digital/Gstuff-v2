            ...
            <div id="accordion-collapse-body-4" class="hidden" aria-labelledby="accordion-collapse-heading-2">
                <div
                    ...
                    <p class="mt-2">{{ __('faq.payment_methods.contact') }} <a href="mailto:support@gstuff.ch"
                            class="text-blue-600 hover:underline">support@gstuff.ch</a>. {{ __('faq.payment_methods.solution') }}</p>
                </div>
            </div>
            ...
            <div id="accordion-collapse-body-6" class="hidden border-b border-gray-300"
                ...
                <div
                    ...
                    <p><b>{{ __('faq.organizations.social_support') }}</b><br>
                        {{ __('faq.organizations.aspasie') }} – <a href="https://www.apasie.ch" target="_blank">www.apasie.ch</a></p>
                    <p>{{ __('faq.organizations.astree') }} – <a href="https://www.astree.ch" target="_blank">www.astree.ch</a></p>
                    <p>{{ __('faq.organizations.procore') }} – <a href="https://procore-info.ch" target="_blank">procore-info.ch</a></p>
                    <p>{{ __('faq.organizations.tandem') }} – <a href="https://www.tandem91.org" target="_blank">www.tandem91.org</a></p>
                    <p>{{ __('faq.organizations.point_appui') }} – <a href="https://www.eglisemigrationvd.com" target="_blank">www.eglisemigrationvd.com</a></p>
                    <p>{{ __('faq.organizations.lavi') }} – <a href="tel:0216310300">021 631 03 00</a></p>
                    <p>{{ __('faq.organizations.appartenances') }} – <a href="https://www.appartenances.ch" target="_blank">www.appartenances.ch</a></p>
                    <p>{{ __('faq.organizations.abs') }} – <a href="https://www.fondationabs.ch" target="_blank">www.fondationabs.ch</a></p>
                    <p>{{ __('faq.organizations.caritas') }} – <a href="https://www.caritas-vaud.ch" target="_blank">www.caritas-vaud.ch</a> – <a href="tel:0216220622">021 622 06 22</a></p>
                    <p>{{ __('faq.organizations.point_eau') }} – <a href="https://www.pointdeau-lausanne.ch" target="_blank">www.pointdeau-lausanne.ch</a></p>
                    <p>{{ __('faq.organizations.appartenances_femmes') }} – <a href="https://www.appartenances.ch" target="_blank">www.appartenances.ch</a> – <a href="tel:0213512880">021 351 28 80</a></p>
                    <p>{{ __('faq.organizations.bourse_travail') }} – <a href="https://www.labourseatravail.ch" target="_blank">www.labourseatravail.ch</a></p>
                    ...
                    <p>{{ __('faq.organizations.csp') }} – <a href="https://www.csp.ch" target="_blank">www.csp.ch</a></p>
                    ...
                    <p>{{ __('faq.organizations.pmu') }} – <a href="https://www.pmu-lausanne.ch" target="_blank">www.pmu-lausanne.ch</a> – <a href="tel:0213146060">021 314 60 60</a><br>
                    ...
                    <p>{{ __('faq.organizations.profa') }} – <a href="https://www.profa.ch" target="_blank">www.profa.ch</a></p>
                    <p>{{ __('faq.organizations.aids_support') }} – <a href="https://www.aids.ch" target="_blank">www.aids.ch</a></p>
