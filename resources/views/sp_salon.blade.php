...
@section('content')
    ...
    <div class="container mx-auto flex flex-col justify-center xl:flex-row">
        ...
        <div x-data="{}" class="mx-auto flex w-full max-w-sm flex-col items-center gap-4 p-4">
            ...
            <div class="text-green-gs font-roboto-slab flex items-center justify-center gap-2">
                <span class="bg-fieldBg flex items-center gap-1 px-2 py-1">
                    {{ __('salon_profile.recruitment') }} :
                </span>
                <span class="text-green-gs font-bold">
