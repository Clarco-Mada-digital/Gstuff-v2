...
<div class="container flex flex-col xl:flex-row justify-center mx-auto">
  ...
  <div class="min-w-3/4 px-5 py-5">
    ...
    <div>
      ...
      <div class="min-w-3/4 px-5 py-5">
        <div class="text-right w-full text-green-gs font-dm-serif font-bold">   / <a href="{{route('salons').'?selectedSalonCanton='.$salon->canton['id'] ?? ''}}">{{Str::ucfirst($salon->canton['nom'] ?? '')}}</a> / {{Str::ucfirst($salon->profile_type ?? '')}} / {{Str::ucfirst($salon->nom_salon)}}</div>
