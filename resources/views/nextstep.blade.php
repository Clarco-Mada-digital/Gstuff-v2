        ...
        <div
            ...
            <div class="flex flex-wrap items-center justify-around">
                <a href="{{ route('registerForm') }}"
                    class="text-green-gs hover:text-green-gs border-green-gs text-sm font-roboto-slab hover:bg-supaGirlRosePastel hover:text-green-gs block w-full transform animate-pulse rounded border md:p-3 p-2 text-center transition duration-300 hover:scale-105 sm:w-[45%]">
