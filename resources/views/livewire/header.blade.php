<div>
    <div class="relative z-30">
        {{-- header --}}
        <nav class="border-gray-200 bg-yellow-50 shadow-lg dark:border-gray-600 dark:bg-gray-900">
            <div x-data="{ 'showUserDrop': false }" class="container mx-auto flex  items-center gap-3 p-4 lg:justify-between">
                ...
                <button data-collapse-toggle="mega-menu-full-humberger" type="button"
                    ...
                    aria-controls="mega-menu-full-humberger" aria-expanded="false">
                ...
                {{-- Menu --}}
                <div id="mega-menu-full-humberger"
                ...
                {{-- Search --}}
                <div class=" mr-0 flex xl:order-1  ">
                    <button data-modal-target="search-modal" data-modal-toggle="search-modal" type="button"
                        class=" rounded-lg p-1 text-sm text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-4 focus:ring-gray-200 md:hidden dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-700">
                ...
                @auth
                    ...
                    <div class="flex  xl:order-1 items-center justify-between w-[100px] bg-red-500">
                        @livewire('notification')
                        <button id="dropdownHoverUser" data-dropdown-toggle="dropdownUser"
                            class="inline-flex cursor-pointer items-center  rounded-lg bg-gray-200 px-2 py-1.5 text-center font-bold focus:outline-none xl:order-1  ml-2"
                            type="button">
                        ...
                        src="https://ui-avatars.com/api/?background=random&name={{ Auth::user()->pseudo ?? (Auth::user()->prenom ?? Auth::user()->nom_salon) }}" @endif
                            ...
                            <svg class="ms-3 h-1.5 w-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
