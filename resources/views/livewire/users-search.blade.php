<div class="w-full flex flex-col items-center justify-center gap-2">
  {{-- loader --}}
  <div wire:loading id="loader" class="absolute inset-0  max-w-[100vw] pointer-events-none overflow-hidden flex items-center justify-center bg-black/75 bg-opacity-50 z-50">
    <div class="text-white text-2xl font-semibold max-h-[100vh] w-full flex items-center justify-center">
        Chargement en cours...
    </div>
  </div>
