                    ...
                    <div x-data="loginForm" class="relative p-4 md:p-5">
                        ...
                        <form x-show="showloginForm" x-on:submit.prevent="submitForm()" id="loginForm" class="space-y-4"
                            ...
                            <div>
                                ...
                                <input x-model="email" type="email" name="email" id="email"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  focus:border-amber-300 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white @error('email') border-red-300 @enderror"
                            ...
                            <div class="relative" x-data="{ 'pwdShow': true }">
                                <label for="conex_pass"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">{{ __('Mot de passe') }}
                                    *</label>
                                <input x-model="password" :type="pwdShow ? 'password' : 'text'" name="pass"
                                    id="conex_pass" placeholder="••••••••"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:border-amber-300 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white"
                                    required />
                                ...
                                <div class="flex items-start">
                                    <div class="flex items-center h-5">
                                        <input x-model="remember" id="remember" type="checkbox" name="remember"
                                            class="w-4 h-4 border border-gray-300 rounded-sm bg-gray-50 focus:ring-3 focus:ring-amber-300 dark:bg-gray-600 dark:border-gray-500 dark:focus:ring-amber-300 dark:ring-offset-gray-800 dark:focus:ring-offset-gray-800"
                                            {{ old('remember') ? 'checked' : '' }} />
                                    </div>
                                    <label for="remember"
                                        class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">{{ __('Se souvenir de moi') }}</label>
                                </div>
                                {{-- @if (Route::has('password.request')) --}}
                                <a href="#" x-on:click="showloginForm = false"
                                    class="text-sm text-green-gs hover:underline hover:text-amber-300 dark:text-green-gs">{{ __('Mot de passe oublié') }}</a>
                                {{-- @endif --}}
                            </div>
                            <button type="submit"
                                class="w-full text-white bg-green-gs hover:bg-amber-300 hover:text-green-gs focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-gs dark:hover:bg-green-gs/30">
                            ...
                            <div
                                class="flex flex-col gap-2 py-5 w-full text-sm lg:text-base items-center justify-center transition-all">
                                <a href="{{ route('registerForm') }}"
                                    class="w-full p-3 text-center border border-amber-300 hover:bg-amber-300 hover:text-green-gs">S'inscrire
                                    gratuitement</a>
                                <a href="{{ route('escort_register') }}"
                                    class="w-full p-3 text-center border border-amber-300 hover:bg-amber-300 hover:text-green-gs">S'inscrire
                                    en tant qu'escorte (Indépendante)</a>
                                <a href="{{ route('salon_register') }}"
                                    class="w-full p-3 text-center border border-amber-300 hover:bg-amber-300 hover:text-green-gs">S'inscrire
                                    en tant que professionnel</a>
                            </div>
                        </form>
                        ...
                        <form x-show="!showloginForm" x-on:submit.prevent="submitForm(true)" id="resetPwdForm"
                            ...
                            <a href="#" x-on:click="showloginForm = true"
                                class="text-sm text-green-gs hover:underline hover:text-amber-300 dark:text-green-gs">{{ __('Retour au formulaire de connexion') }}</a>
                            <button type="submit"
                                class="w-full text-white bg-green-gs hover:bg-amber-300 hover:text-green-gs focus:outline-none font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-green-gs dark:hover:bg-green-gs/30">
                                <svg x-show="loadingRequest" aria-hidden="true"
                                    class="inline w-4 h-4 text-gray-200 animate-spin dark:text-gray-600 fill-green-500"
