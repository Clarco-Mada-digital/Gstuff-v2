                ...
                @guest
                    <div x-data="loginForm" class="relative p-4 md:p-5">
                        ...
                        <form x-show="showloginForm" x-on:submit.prevent="submitForm()" id="loginForm" class="space-y-4"
                            ...
                            <button type="submit"
                                class="bg-green-gs focus:ring-green-gs/50 group relative flex w-full transform cursor-pointer 
                                items-center justify-center gap-2 overflow-hidden rounded-lg px-5 py-2.5 text-center text-xs md:text-sm font-medium 
                                text-white transition-all duration-300 hover:scale-[1.02] hover:bg-green-gs/30 hover:text-green-gs hover:shadow-lg focus:outline-none focus:ring-4">
