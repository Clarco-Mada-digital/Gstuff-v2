    ...
    <div class="container flex flex-col xl:flex-row justify-center mx-auto">
      ...
      <div class="min-w-1/4 flex flex-col items-center gap-3">
        ...
        <div class="flex items-center justify-center gap-2 text-green-gs">
          ...
          <a href="#" class="flex items-center gap-1"> <svg class="w-5 h-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 12h.5m3 0H10m3 0h6m-6 6l6-6m-6-6l6 6"/></svg></svg> Genève</a>
        </div>
        <hr class="w-full h-2">
      ...
      <div class="min-w-3/4 px-5 py-5">
        <div class="text-right w-full text-green-gs font-dm-serif font-bold">Femme / Genève / Escorte / Daniela</div>
