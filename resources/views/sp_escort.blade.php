        ...
        <div class="min-w-1/4 flex flex-col items-center gap-3">
            ...
            <div class="ml-3 flex flex-col justify-center items-center -mt-[25%] md:-mt-[10%] xl:-mt-[25%]">
                <p class="font-bold flex items-center gap-2">{{ Str::ucfirst($escort->prenom) }} @if ($escort->profile_verifie == 'verifier')
                    <svg xmlns="http://www.w3.org/2000/svg" title="Profile verifier par Gstuff" class="w-5 h55 inline-block text-green-gs" viewBox="0 0 24 24"><path fill="currentColor" d="M12 4c-4.41 0-8 3.59-8 8s3.59 8 8 8s8-3.59 8-8s-3.59-8-8-8m-2 13l-4-4l1.41-1.41L10 14.17l6.59-6.59L18 9z" opacity=".3"/><path fill="currentColor" d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10s10-4.48 10-10S17.52 2 12 2m0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8s8 3.59 8 8s-3.59 8-8 8m4.59-12.42L10 14.17l-2.59-2.58L6 13l4 4l8-8z"/></svg>                  
                @endif</p>
            ...
            <a href="tel:{{ $escort->telephone ?? '' }}" class="flex items-center gap-2 font-bold font-dm-serif"><svg
              ...
              <span class="w-full text-center text-green-gs font-bold font-dm-serif">Aucun salon associé pour l'instant</span>
                ...
                @guest
                    <div class="w-full flex flex-col items-center justify-center font-dm-serif gap-5 text-green-gs my-3">
                        ...
                        <p class="font-extrabold text-3xl text-center">Connectez-vous pour voir le contenu privée de Daniela
                        </p>
                        <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
                            class="font-dm-serif font-bold btn-gs-gradient rounded-lg">Se connecter / s'inscrire</button>
                    </div>
                @endguest
                @auth
