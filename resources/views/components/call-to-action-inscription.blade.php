    ...
    <div class="container mx-auto flex flex-col gap-4 px-3 text-white lg:px-10">
        ...
        <div class="w-45 z-10">
            <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal" type="button"
                class="btn-gs-gradient flex items-center justify-center gap-2 rounded-lg px-4 py-2 text-center text-sm font-bold text-black focus:outline-none focus:ring-4 focus:ring-blue-300 dark:focus:ring-blue-800">{{ __('call-to-action-inscription.sign_up') }}
