...
<div class="group relative z-0 mb-5 w-full">
    <select name="{{ $name }}" id="floating_{{ $name }}"
        class="font-roboto-slab focus:border-supaGirlRose border-green-gs @error($name) border-red-500 @enderror text-green-gs peer block w-full appearance-none border-0 border-b-2 bg-transparent px-2 py-2.5 text-sm focus:outline-none focus:ring-0"
