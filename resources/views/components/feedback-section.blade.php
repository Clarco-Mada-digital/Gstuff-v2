<div x-data="carousel()" x-init="init()"
    class="relative py-10 w-full min-h-90 overflow-hidden flex items-center justify-center">
    ...
    <div class="w-full flex items-center justify-center gap-5 flex-nowrap overflow-hidden">
        <template x-for="(item, index) in items" :key="index">
            <div :class="{
                ...
                'translate-x-0 opacity-0 scale-50': currentIndex !== index && currentIndex !== index - 1 &&
                    currentIndex !== index - 2
            }"
                class="min-w-[400px] w-full lg:w-[625px] h-[250px] p-5 bg-white rounded-lg flex flex-col items-center justify-center gap-7 text-xl lg:text-3xl duration-500 flex-shrink-0 md:w-1/3 absolute transition-feed">
                <p class="text-center w-[80%] mx-auto mb-10" x-text="item.content"></p>
