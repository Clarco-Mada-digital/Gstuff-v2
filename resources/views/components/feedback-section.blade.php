<div x-data="carousel()" x-init="init()" class="relative py-10 w-full min-h-90 overflow-hidden flex items-center justify-center">
      ...
      <div
        ...
        <div class="flex items-center w-full justify-center gap-4">
          ...
          <div class="flex flex-col font-bold">
            ...
            <span class="text-sm lg:text-base" x-text="item.post"></span>
          </div>
        </div>
      </div>
    </template>
  </div>
  <button @click="prev()" class="absolute left-10 top-1/2 transform -translate-y-1/2 w-10 h-10 rounded-full shadow bg-amber-300/60 flex items-center justify-center cursor-pointer">
  ...
  <button @click="next()" class="absolute right-10 top-1/2 transform -translate-y-1/2 w-10 h-10 rounded-full shadow bg-amber-300/60 flex items-center justify-center cursor-pointer">
