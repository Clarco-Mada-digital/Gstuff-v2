...
<div class="relative flex-1">
    <textarea id="message-input-{{ $model }}" x-ref="messageInput" x-model="{{ $model }}" rows="1"
        ...
        class="border-supaGirlRose border-1 text-textColor font-roboto-slab focus:border-green-gs focus:ring-green-gs h-8 md:h-12 w-full resize-none overflow-hidden rounded-full border text-xs md:text-sm  md:p-3 p-2 pr-10 focus:outline-none focus:ring-2"
