...
<div class="flex w-full flex-col items-center justify-center gap-5">
    ...
    <div
        class="font-roboto-slab text-supaGirlRose {{ $class }} my-3 flex w-full flex-col items-center justify-center gap-5">
        ...
        <button data-modal-target="authentication-modal" data-modal-toggle="authentication-modal"
            class="font-roboto-slab bg-green-gs hover:bg-green-gs/80 rounded-lg px-5 py-2 font-bold text-white transition-colors">
            {{ $buttonText }}
        </button>
    </div>
