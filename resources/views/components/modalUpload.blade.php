            ...
            <div class="bg-white rounded-lg shadow-xl w-full max-w-md">
                <div class="p-6">
                    <div class="flex justify-between items-center">
                        ...
                        <span id="stepNumber1">1 / 2</span>
                        <span id="stepNumber2" class="hidden">2 / 2</span>
                    </div>
                            ...
                            <div id="dbDropzoneWrapper">
                                <div id="dbDropzone" class="border-2 border-dashed border-gray-300 rounded-lg p-4 transition-all duration-300 ease-in-out hover:bg-gray-50 cursor-pointer z-10">
                                    <div class="text-center">
                                        ...
                                        <p class="mt-1 text-xs text-gray-500">Déposez les fichiers ici ou cliquez pour télécharger</p>
                                    </div>
                                </div>
...
var dbDropzone = new Dropzone("#dbDropzone", {
    ...
    clickable: true, // Assure que la zone est cliquable
    init: function() {
