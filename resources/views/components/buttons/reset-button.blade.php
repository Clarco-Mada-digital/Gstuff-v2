...
@php
    ...
    $baseClasses = 'font-dm-serif group flex items-center justify-center gap-2 rounded-lg border transition-colors duration-200';
...
<button {{ $attributes->merge(['class' => $buttonClasses]) }} wire:loading.attr="disabled">
    ...
    <span wire:loading wire:target="{{ $loadingTarget }}" class="ml-2">
