...
<div x-data="{
                ...
                <li x-show="escorte.prenom.toLowerCase().includes(search.toLowerCase())" class="my-2">
                    <div
                        ...
                        <div class="flex space-x-4">
                            ...
                            <a href="#" @click.stop.prevent="supprimerRelation(escorte)"
                                x-show="!escorte.createbysalon" class="text-red-500 hover:text-red-700"
                                :data-tooltip-target="'tooltip-supprimer-relation-' + escorte.id"
                                data-tooltip-placement="top">
                                <i class="fas fa-times"></i>
                            </a>
                            <div :id="'tooltip-supprimer-relation-' + escorte.id" role="tooltip"
                                x-show="!escorte.createbysalon"
                                class="tooltip invisible absolute z-10 inline-block rounded-lg bg-gray-900 px-3 py-2 text-sm font-medium text-white opacity-0 shadow-sm transition-opacity duration-300 dark:bg-gray-700">
                            ...
                            <a href="#" @click.stop.prevent="autonomiserEscorte(escorte)"
                                x-show="escorte.createbysalon" class="text-green-gs hover:text-green-gs"
                                :data-tooltip-target="'tooltip-autonomiser-' + escorte.id"
                                data-tooltip-placement="top">
    ...
    <div x-cloak x-show="showSupprimerRelationModal" x-transition.opacity.duration.200ms
        x-trap.inert.noscroll="showSupprimerRelationModal"
        x-on:keydown.esc.window="showSupprimerRelationModal = false"
        ...
        <div x-show="showSupprimerRelationModal"
            ...
            <div
                ...
                <div class="relative flex-auto p-6">
                    <p class="my-4 text-lg leading-relaxed text-gray-600">
                        {{ __('profile.are_you_sure_delete_relation') }} <span
                            x-text="selectedEscorte.prenom"></span>?
                    </p>
                </div>
                <!--footer-->
                <div class="flex items-center justify-end rounded-b border-t border-solid border-gray-300 p-6">
