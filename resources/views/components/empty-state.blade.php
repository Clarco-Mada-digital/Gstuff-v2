...
<div class="flex h-full items-center justify-center">
    <div class="flex flex-col items-center">
        <svg width="99px" height="99px" viewBox="0 0 1024 1024" class="icon" version="1.1"
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <path
                    ...
                    fill="#05595B"></path>
                <path d="M510.4 550.4L372 496 180.8 374.4v355.2l329.6 196 324.8-196V374.4L688.8 483.2z" fill="#05595B">
                </path>
                <path
        ...
        <span class="text-green-gs font-roboto-slab  text-center text-sm  text-textColorParagraph">
            {{ $message }}
        </span>
    </div>
</div>
