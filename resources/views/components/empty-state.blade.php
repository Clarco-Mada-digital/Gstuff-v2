...
<div class="flex h-full items-center justify-center">
    <div class="flex flex-col items-center">
        <svg width="99px" height="99px" viewBox="0 0 1024 1024" class="icon" version="1.1"
            xmlns="http://www.w3.org/2000/svg" fill="#7F55B1">
            ...
            <g id="SVGRepo_iconCarrier">
                ...
                <path
                    ...
                    fill="#7F55B1"></path>
                <path d="M510.4 550.4L372 496 180.8 374.4v355.2l329.6 196 324.8-196V374.4L688.8 483.2z" fill="#7F55B1">
                </path>
                <path
                ...
                <path d="M32 460l148.8-85.6 329.6 176L352 640.8z" fill="#7F55B1"></path>
                <path d="M659.2 693.6l176-90.4V375.2L692 480.8l-179.2 68-2.4 1.6z" fill="#2c323a"></path>
                <path d="M510.4 550.4l148.8 85.6L992 464.8l-156.8-89.6z" fill="#7F55B1"></path>
                <path
        ...
        <span class=" font-roboto-slab  text-center text-sm  text-textColorParagraph">
            {{ $message }}
        </span>
    </div>
</div>
