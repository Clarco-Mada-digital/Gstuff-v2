    ...
    @if (count($origineData) > 6)
        <div class="mt-2">
            <button type="button" id="toggle-origine" class="flex items-center gap-1 text-xs text-gray-500 hover:underline focus:outline-none">
                <svg id="toggle-icon" class="w-3 h-3 text-gray-500 transition-transform" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
...
document.addEventListener('DOMContentLoaded', function () {
    ...
    toggleBtn?.addEventListener('click', () => {
        ...
        toggleLabel.textContent = expanded ? 'Afficher moins' : 'Afficher plus';
