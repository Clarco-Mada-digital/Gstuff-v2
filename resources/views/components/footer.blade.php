...
<div>
        ...
        <div
            ...
            <div
                ...
                <div class="flex flex-col items-center gap-3 lg:items-start">
                    <h3 class="font-roboto-slab text-2xl font-bold sm:text-3xl lg:text-2xl xl:text-3xl">
                ...
                <div class="flex flex-col items-center gap-3 lg:items-start">
                    ...
                    <div class="flex flex-col items-center gap-2 lg:items-start">
                        <a href="{{ route('glossaires.index') }}"
                            class="text-gray-300 transition hover:text-white">{{ __('footer.glossary') }}</a>
                        <a href="{{ route('faq') }}"
                            class="text-gray-300 transition hover:text-white">{{ __('footer.faq') }}</a>
                        <a href="{{ route('about') }}"
                            class="text-gray-300 transition hover:text-white">{{ __('footer.about_us') }}</a>
                        <a href="{{ route('static.page', 'cgv') }}"
                            class="text-gray-300 transition hover:text-white">{{ __('footer.cgv') }}</a>
                        <a href="{{ route('contact') }}"
                            class="text-gray-300 transition hover:text-white">{{ __('footer.contact') }}</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div
        class="font-roboto-slab bg-bgCopyRight text-textColor relative z-30 flex items-center justify-center py-7 text-xs text-white transition-all lg:text-base">
        <p class="text-textColor">Copyright {{ now()->year }} - <a href="{{ route('home') }}"
