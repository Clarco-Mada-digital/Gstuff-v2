    ...
    <div class="flex h-[255px] w-full flex-col justify-center gap-5 px-10 text-white lg:w-[1140px] lg:px-20"
        ...
        <div class="z-10 mt-5">
            <a href="{{ route('contact') }}" type="button"
                class="cursor-pointer group relative overflow-hidden bg-complementaryColorViolet flex w-52 items-center justify-center gap-2 rounded-lg px-4 py-2 text-center text-sm font-bold text-white focus:outline-none focus:ring-4 focus:ring-supaGirlRose/50 hover:bg-opacity-90 transition-all duration-300 transform hover:scale-105 hover:shadow-lg lg:text-base">{{ __('call-to-action-contact.write_us') }}
