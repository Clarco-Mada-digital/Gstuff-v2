...
<div
    class="font-roboto-slab mx-auto h-[60vh] w-full rounded-lg bg-white p-6 shadow-lg md:h-[55vh] md:w-[70vw] xl:h-[60vh] xl:w-[50vw]">
    <ul class="mb-5 divide-x divide-gray-200 rounded-lg text-center text-sm font-medium text-gray-500 shadow sm:flex dark:divide-gray-700 dark:text-gray-400"
        ...
        <li class="flex-1">
            <button id="new-invitation-tab" data-tabs-target="#new-invitation" type="button" role="tab"
                ...
                class="text-green-gs w-full rounded-l-lg bg-gray-100 p-4 dark:bg-gray-800 dark:text-blue-500">
    ...
    <div id="tabs-content" class="md:h-[calc(100%-4rem)] xl:h-[calc(100%-4rem)]">
        <!-- Nouvelle invitation -->
        <form id="new-invitation" role="tabpanel" aria-labelledby="new-invitation-tab"
            action="{{ route('inviter.escorte') }}" method="POST" class="h-full">
            @csrf
            <div class="mx-auto flex items-center">
                ...
                <div class="relative w-full">
                    ...
                    <input type="text" id="simple-search-new"
                        class="focus:border-green-gs focus:ring-green-gs block w-full rounded-lg border border-gray-300 bg-gray-50 p-2.5 ps-10 text-sm text-gray-900 dark:border-gray-600 dark:bg-gray-700 dark:text-white dark:placeholder-gray-400 dark:focus:border-blue-500 dark:focus:ring-blue-500"
            ...
            <ul class="h-[30vh] divide-y divide-gray-200 overflow-y-auto p-5 md:h-[30vh] xl:h-[35vh] dark:divide-gray-700"
                ...
                @foreach ($escortsNoInvited as $escort)
                    <li class="pb-0 pt-3 sm:pt-4" data-name="{{ $escort->prenom }}" data-email="{{ $escort->email }}">
                        <div class="flex items-center space-x-4 rtl:space-x-reverse">
                            <div class="shrink-0">
                                <img class="h-8 w-8 rounded-full"
                                    src="{{ $escort->avatar ? asset('storage/avatars/' . $escort->avatar) : asset('images/icon_logo.png') }}"
                                    alt="{{ $escort->prenom }}">
                            </div>
                            ...
                            <div class="inline-flex items-center text-base font-semibold text-gray-900 dark:text-white">
                                <input id="escort-{{ $escort->id }}" name="escort_ids[]" type="checkbox"
                                    value="{{ $escort->id }}"
                                    class="text-green-gs focus:ring-green-gs h-4 w-4 rounded-sm border-gray-300 bg-gray-100 focus:ring-2 dark:border-gray-600 dark:bg-gray-700 dark:ring-offset-gray-800 dark:focus:ring-blue-600">
                            </div>
                        </div>
                    </li>
                @endforeach
            ...
            <div class="flex justify-center">
                <button type="submit"
                    class="bg-green-gs border-green-gs hover:bg-green-gs/80 my-2 w-full rounded-lg border p-2.5 text-sm font-medium text-white focus:outline-none focus:ring-4 focus:ring-blue-300 md:w-auto dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
        ...
        <div id="pending-invitation" role="tabpanel" aria-labelledby="pending-invitation-tab" class="h-full">
            ...
            <ul class="h-auto max-h-[calc(100%-4rem)] divide-y divide-gray-200 overflow-y-auto p-5 dark:divide-gray-700"
                id="escort-list-pending">
