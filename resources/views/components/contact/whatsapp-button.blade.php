...
<div x-data="{ openModal: false }" class="relative group w-full">
    <!-- Bouton principal -->
    <button
        @click="openModal = {{ $phone && !$isPause ? 'true' : 'false' }}"
...
>
    <div class="relative bg-white rounded-lg p-6 w-full max-w-lg shadow-xl">
        ...
        <div class="flex items-center space-x-2 mb-4">
            <h2 class="text-xl font-bold text-gray-800">{{ __('escort_profile.contact_person', ['name' => $name]) }}</h2>
            @if($profileVerifier)
                <span class="inline-flex items-center gap-1 px-2 py-1 text-xs font-semibold text-green-700 bg-green-100 rounded">
        ...
        <!-- Mention -->
        <p class="text-sm text-supaGirlRose mb-2 text-center">
        ...
        <div class="flex flex-row items-center justify-around">
            ...
            <a
                ...
                target="_blank"
                class="inline-flex items-center gap-2 px-4 py-2 bg-supaGirlRose text-white rounded hover:bg-fieldBg hover:text-green-gs w-1/3 justify-center"
            >
            <svg class="h-5 w-5" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
            <g fill="none" fill-rule="evenodd">
                <path
            ...
            <a
                href="tel:{{ $cleanPhone }}"
                class="inline-flex items-center text-sm gap-2 px-4 py-2 bg-green-600 text-white rounded hover:bg-green-700 w-1/3 justify-center"
            >
