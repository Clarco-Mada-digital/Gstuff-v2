    <div>
        ...
        <div id="modalOverlay" class="modal-overlay z-50">
            <div class="w-full md:w-[80vw] xl:w-[60vw] rounded-lg bg-white p-6 font-roboto-slab shadow-xl mt-10">
...
const initializeGalleryModal = () => {
    ...
    const processFiles = (fileList) => {
        ...
        const validFiles = filesArray.filter(file => file.type.match('image.*') || file.type.match('video.*'));
