...
Naviguer sur Gstuff, c'est aussi n'avoir besoin que d'une seule ressource pour trouver tout ce qui attrait à la sexualité. Vous trouverez naturellement diverses informations en lien avec les services sexuels, mais également de l'information sur l'actualité érotique suisse, des liens utiles vers diverses administrations et un soutien par des professionnels de la sexologie si besoin."
    ...
    'advantages' => [
        ...
        'items' => [
            ...
            'Bénéficier d\'informations régulièrement mises à jour',
    ...
    'payment_methods' => [
        'question' => 'Quels sont les moyens de paiement pour valider et publier votre annonce ?',
        'methods' => [
            'Payer en ligne, de manière sécurisée ; la validation est alors instantanée.',
            'Payer en cash ; la validation se fait au moment du rendez-vous en présentiel.'
        ],
        'contact' => 'En cas de difficulté ou pour toute situation particulière, vous pouvez contacter le support à',
        'solution' => 'Nous vous aiderons à trouver une solution adéquate.'
    ],
    'deactivate_profile' => [
        ...
        'return_instructions' => 'Dès votre retour, vous pourrez à nouveau vous connecter à votre profil et sélectionner « Je réactive mon profil ». A ce moment-là, votre profil sera à nouveau visible en clair et les informations de contact seront à nouveau visibles pour les utilisateurs qui pourront alors vous contacter sans attendre.'
    ],
    'help' => [
        ...
        'romandie_note' => 'Pour la Suisse Romande, en plus des liens ci-dessus, les adresses suivantes pourraient vous intéresser :'
    ],
    'organizations' => [
        'social_support' => 'Aides sociales et Formations',
        'legal_services' => 'Service Juridiques',
        'medical_services' => 'Services médicaux et consultations',
        'maternity' => 'Maternité',
        'emergency_maternity' => 'Urgence Maternité',
        'gynecology' => 'Rendez-Vous gynécologiques',
        'hiv_std_tests' => 'Consultation VIH/IST / Tests Anonymes',
        'flon_office' => 'Permanences Flon',
        'sexual_health' => 'Consultation de Santé Sexuelle / Planning Familial',
        'aids_support' => 'Aide Suisse Contre le Sida',
        'aspasie' => 'Aspasie – Association en faveur des professionnels (les) du sexe – Genève',
        'astree' => 'Astrée – Association de Soutien aux Victimes de Traite et d’Exploitation',
        'procore' => 'ProCore – Réseau Suisse d’Organisations qui défendent les intérêts des travailleuses et travailleurs du sexe',
        'tandem' => 'Tandem – Association pour l\'aide aux personnes en difficulté, marginalisées, toxicodépendantes, prostituées',
        'point_appui' => 'Point d\'Appui – Espace Multiculturel des Eglises',
        'lavi' => 'Centre LAVI – Association pour les Victimes d\'actes de violence',
        'appartenances' => 'Association Appartenances – Accueil, information et formation pour les personnes migrantes',
        'abs' => 'Fondation ABS – Association d\'aide aux personnes toxicodépendantes',
        'caritas' => 'Caritas – Soutien social Lausanne',
        'point_eau' => 'Point D\'eau Lausanne – Espace de soins et d\'orientation',
        'appartenances_femmes' => 'Appartenances Centre Femmes – Cours de français pour les femmes non francophones',
        'bourse_travail' => 'Bourse à Travail – Centre de formation pour personnes en situation précaire et/ou migrantes',
        'cedre' => 'CEDRE',
        'saje' => 'SAJE – Service d\'Aide Juridique aux Exilé-e-s',
        'csp' => 'Centre Social Protestant FRAT – Service social actif dans le domaine de la migration',
        'chuv' => 'CHUV – Centre Hospitalier Universitaire Vaudois',
        'pmu' => 'PMU – Polyclinique Médicale Universitaire',
        'profa' => 'Profa – Consultation de Santé Sexuelle / Planning Familial'
    ]
];
