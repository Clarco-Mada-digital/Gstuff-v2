...
return [
    ...
    'what_is_supagirl' => [
        'question' => 'What is Supagirl.ch?',
        'answer' => "Supagirl.ch is a Swiss erotic classifieds website. It lists sex workers operating in Switzerland.

It allows advertisers to gain visibility with an open and respectful audience. It enables everyone to browse the site and find answers to their fantasies. Supagirl aims to be inclusive, focusing solely on pleasure.

Browsing Supagirl means having a single resource for everything related to sexuality. You'll naturally find various information related to sexual services, as well as updates on Swiss erotic news, useful links to various administrations, and support from sexology professionals if needed."
    ],
    'advantages' => [
        'question' => 'What are the advantages of registering on Supagirl?',
        'items' => [
        ...
        'summary' => 'In summary, Supagirl.ch guarantees a platform that stands out not only by its appearance but also by its ease of use and the quality of the information it provides.'
    ],
    'requirements' => [
        'question' => 'What are the 3 requirements to register on Supagirl?',
        'age' => 'Be of legal age:',
        'age_text' => 'To visit the site, you must be of legal age to do so. In Switzerland, you must be at least 18 years old to browse Supagirl. Similarly, to create a profile or post an ad, you must be of legal age. This is the only requirement if you are not posting an ad.',
        'age_note' => 'Note that you must also not be under guardianship or curatorship.',
        'work_in_switzerland' => 'Work in Switzerland:',
        'work_in_switzerland_text' => 'Indeed, Supagirl is a 100% Swiss site. Only people offering their services in Switzerland can post an ad on Supagirl. You will notice that only Swiss cantons and cities are available when creating your profile.',
    ...
    'deactivate_profile' => [
        ...
        'text1' => 'When you rent a space on Supagirl to feature your ad, you pay the amount corresponding to the desired service. For example, you rent a space for one month and you pay for one month of service.',
        'why_pay' => 'But why pay during an absence? Supagirl wants you to get the most out of the services offered, which is why, when you are away, whether on vacation, taking a break, or for any other personal reason, you can put your profile on pause and thus truly enjoy all the time you\'ve paid for.',
    ...
    'help' => [
        ...
        'intro' => 'Supagirl provides you with useful addresses below for various types of requests, although this list is not exhaustive. If you have a specific request and cannot find the answer below, contact us at',
