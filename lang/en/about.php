...
return [
    ...
    'welcome_text' => 'Welcome to Supagirl.ch, the Swiss platform for erotic ads dedicated to celebrating sexual pleasure in all its diversity.',
    'decorative_image_alt' => 'Decorative image',
    'genesis_of_Supagirl' => 'Genesis of Supagirl',
    'genesis_description_1' => 'Supagirl is written with a capital G, referring to the pleasure zone called the G-spot or G-zone, and thus means everything related to pleasure. Therefore, Supagirl aims to be an inclusive erotic ads site, meaning that only pleasure matters, regardless of how and with whom, as long as it remains between consenting adults.',
    'genesis_description_2' => 'Erotic pleasure is an intimate facet of the human experience that transcends gender identity boundaries. It is a rich territory of sensations, emotions, and connections that link us to our deepest essence. For Supagirl, it is essential to celebrate erotic pleasure inclusively, embracing all gender identities. From gender fluidity to non-conformity, every individual deserves to explore their sexuality freely without fear or judgment.',
